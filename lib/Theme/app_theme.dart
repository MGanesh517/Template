  ...
  static ThemeData lightTheme({
    ...
    return ThemeData(
      ...
      colorScheme: Theme.of(context).colorScheme.copyWith(
          ...
          brightness: Brightness.light,
          error: const Color.fromRGBO(221, 48, 82, 1),
          primaryFixed: Color.fromRGBO(99, 51, 120, 1),
          secondaryContainer: const Color.fromRGBO(126, 32, 57, 1),
          secondary: const Color.fromRGBO(197, 0, 53, 1)),
