...
import 'package:template/Common%20Components/Common%20Widgets/common_popup_menu.dart';
...
class NavigationItems {
  ...
  static final List<NavigationItemCommon> items = [
    NavigationItemCommon(
      ...
      label: 'Masters List',
      onTap: () => Get.toNamed('/mastersListScreen'),
    ),
    NavigationItemCommon(
      icon: Icons.book,
      label: 'Leads',
      onTap: () => Get.toNamed('/leadsListScreen'),
    ),
    NavigationItemCommon(
